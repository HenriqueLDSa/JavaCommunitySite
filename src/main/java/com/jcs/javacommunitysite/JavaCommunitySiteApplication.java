    ...
    public void init() {
        try {
            ...
            jetstreamClient = new JetstreamWebsocketClient(new URI("wss://jetstream1.us-east.bsky.network/subscribe"
                    ...
                    + "&wantedCollections=dev.fudgeu.experimental.atforumv1.admin.admingrant"
                    + "&wantedCollections=dev.fudgeu.experimental.atforumv1.admin.hideuser"
                    + "&wantedCollections=dev.fudgeu.experimental.atforumv1.admin.hidepost"
                    + "&wantedCollections=dev.fudgeu.experimental.atforumv1.admin.hidereply"
            ));
