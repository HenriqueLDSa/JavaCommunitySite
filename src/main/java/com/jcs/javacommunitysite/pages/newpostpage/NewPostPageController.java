...
// import com.jcs.javacommunitysite.forms.NewPostFormOld;
...
//         model.addAttribute("postForm", new NewPostFormOld());
//         return "newpost";
//     }

//     @PostMapping("/newPost")
//     public String createPost(@ModelAttribute NewPostFormOld newPostForm, Model model) {
//         try {
//             var clientOpt = sessionService.getCurrentClient();
//             if (clientOpt.isEmpty() || !sessionService.isAuthenticated()) {
